...
/**
 * RELEASE CONFIGURATION UPDATER (JavaScript version)
 * ====================================================
 * 
 * A Node.js script to update RELEASE_DETAILS and deploymentWindows 
 * in testDataConfig_CRE.ts based on deployment dates from Excel.
 * 
 * Usage: node scripts/updateReleaseConfig.js 2026.03.00
 * 
...
if (!releaseVersion) {
  ...
  console.error('Usage: node scripts/updateReleaseConfig.js 2026.03.00');
  process.exit(1);
}
 ...
 */
function findDeploymentDates(data, releaseVersion) {
 ...
 * Conversion: (excelSerialNumber - 25569) converts to milliseconds from Unix epoch
 */
 ...
 */
function updateConfigFile(configPath, releaseVersion, deploymentDates) {
